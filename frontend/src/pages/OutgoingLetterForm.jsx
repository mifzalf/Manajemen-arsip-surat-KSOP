  ...
  return (
    <div className="max-w-2xl mx-auto py-8">
      <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
        <h2 className="text-2xl font-bold mb-6 text-gray-800 dark:text-white/90">Form Surat Keluar</h2>
        <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
              <label className="block mb-1.5 text-sm font-medium text-gray-700 dark:text-gray-400">Tanggal Keluar</label>
              <input
                type="date"
                name="entryDate"
          ...
          <div>
            <label className="block mb-1.5 text-sm font-medium text-gray-700 dark:text-gray-400">Penerima</label>
            <input
              type="text"
              name="recipient"
